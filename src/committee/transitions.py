...
TRANSITION_RULES: list[TransitionRule] = [
    ...
    TransitionRule(
        ...
        description="User intervenes or requests revision during decision phase.",
    ),
    TransitionRule(
        from_state=CommitteeState.REFLECTION,
        event_type=EventType.USER_OVERRIDE,
        to_state=resolve_user_override_target_state,
        gate=gate_user_override,
        description="User intervenes or requests revision after decision during reflection.",
    ),
    TransitionRule(
    ...
    TransitionRule(
        ...
        to_state=resolve_user_override_target_state,
        gate=gate_user_override,
        description="User intervenes during investigation phase.",
    ),
    TransitionRule(
        from_state=CommitteeState.DIVERGENCE,
        event_type=EventType.USER_OVERRIDE,
        to_state=resolve_user_override_target_state,
        gate=gate_user_override,
        description="User intervenes during divergence phase.",
    ),
    TransitionRule(
        from_state=CommitteeState.CONFRONTATION,
        event_type=EventType.USER_OVERRIDE,
        to_state=resolve_user_override_target_state,
        gate=gate_user_override,
        description="User intervenes during confrontation phase.",
    ),
    TransitionRule(
        from_state=CommitteeState.DEFENSE,
        event_type=EventType.USER_OVERRIDE,
        to_state=resolve_user_override_target_state,
        gate=gate_user_override,
        description="User intervenes during defense phase.",
    ),
    TransitionRule(
        from_state=CommitteeState.CONVERGENCE,
        event_type=EventType.USER_OVERRIDE,
        to_state=resolve_user_override_target_state,
        gate=gate_user_override,
        description="User intervenes during convergence phase.",
    ),
    TransitionRule(
        from_state=CommitteeState.WAITING_FOR_USER,
        event_type=EventType.USER_OVERRIDE,
        to_state=resolve_user_override_target_state,
        gate=gate_user_override,
        description="User intervenes or requests revision while waiting for input.",
    ),
    # 13. Cancellation
    TransitionRule(
        from_state=CommitteeState.INVESTIGATION,
    ...
    TransitionRule(
        ...
        to_state=CommitteeState.CANCELLED,
        gate=gate_session_cancelled,
        description="User aborts session while suspended due to insufficient evidence.",
    ),
    TransitionRule(
        from_state=CommitteeState.BLOCKED,
        event_type=EventType.SESSION_CANCELLED,
        to_state=CommitteeState.CANCELLED,
        gate=gate_session_cancelled,
        description="User aborts blocked session.",
    ),
    TransitionRule(
        from_state=CommitteeState.DRAFT,
        event_type=EventType.CRITICAL_ERROR,
        to_state=CommitteeState.BLOCKED,
        gate=gate_critical_error,
        description="System error caused session to block.",
    ),
    TransitionRule(
        from_state=CommitteeState.INVESTIGATION,
        event_type=EventType.CRITICAL_ERROR,
